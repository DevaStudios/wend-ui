...
declare global {
  namespace JSX {
    interface IntrinsicElements {
      'wend-text-area': React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement> & {
        label?: string;
        'show-label'?: boolean;
        value?: string;
        placeholder?: string;
...
const meta: Meta<WendTextAreaArgs> = {
...
export default meta;
type Story = StoryObj<WendTextAreaArgs>;
